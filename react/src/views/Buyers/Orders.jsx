...
export default function AOrders() {
  ...
  return (
    ...
    <div className="px-48 py-5">
      ...
      >
        <Tabs.Item active icon={FaShoppingCart} title="Shopping Cart">
          <div className="bg-gray-100 w-full">
            <p className="text-xl text-center mt-3 ">Shopping Cart</p>
        ...
        <Tabs.Item active icon={HiUserCircle} title="To Recieve">
          <div className="bg-gray-100 w-full">
            <p className="text-xl text-center mt-3">To Recieve</p>
            <p className="text-xs mt-0 mb-6 text-center italic">
        ...
        {/* SECOND TAB */}
        <Tabs.Item active icon={BiCheck} title="Transactions">
          <div className="bg-black-100 w-full">
            <p className="text-xl text-center mt-3">Succesfull Transactions</p>   
            {data.userPendingOrders.map((order) => (
              <div className="bg-slate-200" key={order.id}>
                {order.transactions.map(
                  (transaction) =>
