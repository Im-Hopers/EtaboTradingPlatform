  ...
  return (
    <div className="mt-3 mx-6">
      ...
      >
          ...
          <div className="rounded p-4 mb-5  ">
            <div className="rounded-tl-3xl  ">
              ...
              <form onSubmit={addProductForm}>
                {/* START */}
                <div
                  className="rounded p-2 mb-5 bg-green-300 dark:bg-gray-900 flex items-center justify-center"
        ...
        <Tabs.Item active icon={HiUserCircle} title="To-Process">
                      ...
                      >
                        <div className="mt-0 flex flex-col xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0 bg-slate-300">
                          <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                            ...
                            <div className="flex flex-col justify-start items-start bg-green-300 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                              <p className="text-lg md:text-xl font-semibold leading-6 xl:leading-5 text-grwee-800">
                                Transaction No: {order.id}
                              </p>
                            ...
                            <div className="flex justify-center md:flex-row flex-col items-stretch ">
                              <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-green-300  space-y-6">
                              ...
                              <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-green-300   space-y-6">
                                <h3 className="text-xl font-semibold leading-5 text-gray-800">
                                  Order Status : <br />
                                  <span className="text-sm border-y-orange-400">
                                    {" "}
